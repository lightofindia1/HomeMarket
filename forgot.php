...
<head>
    <meta charset="utf-8">
    <title>Forgot Password | HomeMarket</title>
...
<div class="container" id="forgotpassword-form">
	<a href="index-2.html" class="login-logo"><img src="assets/img/logo-dark.png"></a>
	<div class="row">
				...
				<form action="#" class="form-horizontal">
					...
					<div class="panel-footer">
						<div class="clearfix">
							...
							<button class="btn btn-primary btn-raised pull-left" id="reset">Reset</button>
						</div>
					</div>
				</form>
			</div>
