...
<head>
    <meta charset="utf-8">
    <title><?php echo $Error;?> | HomeMarket</title>
                ...
                <div class="static-content-wrapper">
                    <center><div class="static-content">
						<div class="page-heading">
							<h1 style="float:none"><?php echo $ErrorCode." - ".$Error;?></h1>
							<?php echo $_SERVER['REQUEST_URI'];?>
						</div>
                        <div class="page-content">
                            <div class="container-fluid">
								<a href="#" onclick="javascript:window.history.back();" class="btn btn-success btn-raised"><i class="fa fa-reply"></i> Go Back</a>
								<a href="home" class="btn btn-primary btn-raised"><i class="fa fa-home"></i> Return to Home</a>
								<br><center><i class="material-icons" style="font-size:400px;color:black">devices</i></center>
							</div>
                        </div> <!-- #page-content -->
                    </div></center>
